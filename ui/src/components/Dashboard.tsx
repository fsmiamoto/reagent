...
import { FlaskConical, Loader2, AlertCircle, FileText, Clock, RefreshCw } from 'lucide-react';
            ...
            <main className="max-w-6xl mx-auto px-6 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground mt-1">
                        {sessions.length} {sessions.length === 1 ? 'review' : 'reviews'} in total
                    </p>
                </div>
                ...
                {error && (
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <h2 className="mt-4 text-lg font-semibold text-foreground">Failed to Load Reviews</h2>
                            ...
                            >
                                ...
                                <div className="mt-4 flex items-center gap-4 text-xs text-muted-foreground">
                                    <span className="flex items-center gap-1">
                                        ...
                                        {session.filesCount} {session.filesCount === 1 ? 'file' : 'files'}
                                    </span>
                                    <span className="flex items-center gap-1">
